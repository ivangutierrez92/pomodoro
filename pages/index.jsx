      ...
      <main>
        ...
        <section className={styles.info}>
          ...
          <article className={styles.sectionInfo}>
            <h3 className={styles['sectionInfo__title']}>¿Qué es pomodoro?</h3>
            <p>
          ...
          <article className={styles.sectionInfo}>
            <h3 className={styles['sectionInfo__title']}>¿Qué puede hacer esta aplicacion?</h3>
            <p>
              La aplicación ayuda a la ejecución de la técnica Pomodoro, pudiendo alternar entre la
              sesión de trabajo y el descanso. Además, se puede configurar cuánto dura la sesión y
              el descanso. Finalmente, la página puede ser instalada como aplicación.
            </p>
          </article>
          <article className={styles.sectionInfo}>
            <h3 className={styles['sectionInfo__title']}>¿Por qué esta aplicación?</h3>
            <p>
